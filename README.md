...
The code is constructed in a way than allows solving the problem for other figures as well. But... for all the chess' figures except knight the problem is solvable in linear time (e.g. queen or rook) or not solvable at all (e.g. pawn or bishop). Because of this I've added a definition of an artificial figure called superking which can "jump"
